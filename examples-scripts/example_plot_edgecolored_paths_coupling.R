...
library(GGally)
png("mux_coupling_path_stats_1.png", width=1024, height=1024, res=120)
...
library(corrplot)
png("mux_coupling_path_stats_2.png", width=1024, height=1024,, res=200)
